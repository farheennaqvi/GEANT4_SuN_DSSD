...
SuNPhysicsListMessenger::SuNPhysicsListMessenger(SuNPhysicsList* pPhys)
:pPhysicsList(pPhys)
{   
  physDir = new G4UIdirectory("/SuN/phys/");
  physDir->SetGuidance("physics control.");

  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/setGCut",this);  
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/setECut",this);  
  ...
  protoCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/setPCut",this);  
  ...
  allCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/setCuts",this);
  ...
  eCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/TargetCuts",this);
  ...
  mCutCmd = new G4UIcmdWithADoubleAndUnit("/SuN/phys/DetectorCuts",this);
  ...
  pListCmd = new G4UIcmdWithAString("/SuN/phys/SelectPhysics",this);
...
SuNPhysicsListMessenger::~SuNPhysicsListMessenger()
{
  delete physDir;
  delete gammaCutCmd;
  delete electCutCmd;
...
void SuNPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
